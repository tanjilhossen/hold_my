...
(async () => {
    console.log(`\n==========================================================`);
    console.log(`   TAQAMUL LIVE INTERACTIVE LOGIN BOT   `);
    ...
    page.on('request', req => {
        try {
            ...
            if (auth && auth.startsWith('Bearer ') && !auth.includes('undefined')) {
                ...
                console.log("\n🎯 [SUCCESS] INTERCEPTED ACTIVE BEARER TOKEN!");
    ...
    console.log("[Token Bot] Submitting Login Form...");
    try {
    ...
    console.log("\n==========================================================");
    console.log(" 📺 CHROME IS NOW OPEN ON YOUR SCREEN!");
    console.log(" 📩 PLEASE ENTER THE 6-DIGIT OTP IN THE CHROME BROWSER WINDOW.");
    console.log("==========================================================\n");
